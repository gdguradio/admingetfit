          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('registeruser/UserProfile/userProfile/'.$this->session->userdata('UserID'));?>" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo site_url('assets/img/logo/logo3.png');//echo site_url('assets/user_photo/'.$photo); ?>" class="img-circle" alt="User Image">
        </div>
        ...
        <?php foreach ($menu as $m):?>
            ...
            <?php if($CI->masterdatarole->hasAccess($m->SysID,'menu') == 'yes'): ?>
                    <?php if ($m->HasChild == 'no'): ?>
                        <li><a href="<?= site_url($m->Link) ?>"><i class="<?=$m->FaIcon?>"></i> <span><?= $m->MenuName ?></span></a></li>
                    <?php else: ?>
                        <li class="treeview">
                            <a href="#">
                                <i class="<?=$m->FaIcon?>"></i>
