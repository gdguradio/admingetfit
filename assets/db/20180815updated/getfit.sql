...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2018 at 03:20 AM
...
CREATE TABLE `masterdatasecretquestion` (
  `SysID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `AddedDate` date NOT NULL,
  `UpdatedDate` date NOT NULL,
  `SecretQuestionStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL,
  PRIMARY KEY (`SysID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


CREATE TABLE `gymmainloginsecretquestion` (
  `SysID` int(11) NOT NULL AUTO_INCREMENT,
  `FirstName` varchar(50) NOT NULL,
  `MiddleName` varchar(50) DEFAULT NULL,
  `LastName` varchar(50) NOT NULL,
  `Suffix` varchar(10) DEFAULT NULL,
  `GymMainLoginID` int(11) DEFAULT NULL,
  `UserName` varchar(20) DEFAULT NULL,
  `Password` varchar(250) NOT NULL,
  `EmailAddress` varchar(100) NOT NULL,
  `LandLineNumber` varchar(20) DEFAULT NULL,
...
CREATE TABLE `masterdatabulletinboard` (
  ...
  `EntryDescription` Text DEFAULT NULL,
  `EntryShowTo` varchar(50) NOT NULL,
