...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2018 at 08:54 AM
...
--
-- Table structure for table `gymresourcesassetsartwork`
--

CREATE TABLE `gymresourcesassetsartwork` (
  `SysID` int(11) NOT NULL,
  `ResourcesAssetsArtworkName` varchar(200) DEFAULT NULL,
  `Description` varchar(200) DEFAULT NULL,
  `DocumentLink` varchar(200) DEFAULT NULL,
  `QueryInformation` varchar(200) DEFAULT NULL,
  `AddedBy` int(11) NOT NULL,
  `UpdatedBy` int(11) DEFAULT NULL,
  `AddedDate` date NOT NULL,
  `UpdatedDate` date DEFAULT NULL,
  `DisplayOrderIndex` varchar(200) DEFAULT NULL,
  `resourcesassetsartworkStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `gymresourcesassetsartworkshowto`
--

CREATE TABLE `gymresourcesassetsartworkshowto` (
  `SysID` int(11) NOT NULL,
  `gymresourcesassetsartworkID` int(11) DEFAULT NULL,
  `ShowToBranch` int(11) NOT NULL,
...
--
-- Table structure for table `gymresourcescampaign`
--

CREATE TABLE `gymresourcescampaign` (
  `SysID` int(11) NOT NULL,
  `ResourcesCampaignName` varchar(200) DEFAULT NULL,
  `Description` varchar(200) DEFAULT NULL,
  `DocumentLink` varchar(200) DEFAULT NULL,
  `QueryInformation` varchar(200) DEFAULT NULL,
  `AddedBy` int(11) NOT NULL,
  ...
  `UpdatedDate` date DEFAULT NULL,
  `DisplayOrderIndex` varchar(200) DEFAULT NULL,
  `resourcescampaignStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `gymresourcescampaignshowto`
--

CREATE TABLE `gymresourcescampaignshowto` (
  `SysID` int(11) NOT NULL,
  `gymresourcescampaignID` int(11) DEFAULT NULL,
  `ShowToBranch` int(11) NOT NULL,
  `ShowToBranchRole` int(11) NOT NULL,
  `AddedBy` int(11) NOT NULL,
  `UpdatedBy` int(11) NOT NULL,
...
--
-- Table structure for table `gymresourcesdigitalsocialmedia`
--

CREATE TABLE `gymresourcesdigitalsocialmedia` (
  `SysID` int(11) NOT NULL,
  `ResourcesDigitalSocialMediaName` varchar(200) DEFAULT NULL,
  `Description` varchar(200) DEFAULT NULL,
  `DocumentLink` varchar(200) DEFAULT NULL,
  `QueryInformation` varchar(200) DEFAULT NULL,
  `AddedBy` int(11) NOT NULL,
  ...
  `UpdatedDate` date DEFAULT NULL,
  `DisplayOrderIndex` varchar(200) DEFAULT NULL,
  `resourcesdigitalsocialmediaStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `gymresourcesdigitalsocialmediashowto`
--

CREATE TABLE `gymresourcesdigitalsocialmediashowto` (
  `SysID` int(11) NOT NULL,
  `gymresourcesdigitalsocialmediaID` int(11) DEFAULT NULL,
  `ShowToBranch` int(11) NOT NULL,
  `ShowToBranchRole` int(11) NOT NULL,
  `AddedBy` int(11) NOT NULL,
  `UpdatedBy` int(11) NOT NULL,
...
--
-- Table structure for table `gymresourcesmarketing`
--

CREATE TABLE `gymresourcesmarketing` (
  `SysID` int(11) NOT NULL,
  `ResourcesMarketingName` varchar(200) DEFAULT NULL,
  `Description` text,
  `DocumentLink` varchar(200) DEFAULT NULL,
  `QueryInformation` varchar(200) DEFAULT NULL,
  `AddedBy` int(11) NOT NULL,
  ...
  `AddedDate` date NOT NULL,
  `UpdatedDate` date DEFAULT NULL,
  `DisplayOrderIndex` varchar(200) NOT NULL,
  `ResourcesMarketingStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `gymresourcesmarketing`
--

INSERT INTO `gymresourcesmarketing` (`SysID`, `ResourcesMarketingName`, `Description`, `DocumentLink`, `QueryInformation`, `AddedBy`, `UpdatedBy`, `AddedDate`, `UpdatedDate`, `DisplayOrderIndex`, `ResourcesMarketingStatus`, `DeleteStatus`) VALUES
(1, 'Marketing Resources Name', 'Marketing Resources ', 'a657dc4feec5041ca6cbdf699e11a8f4.pdf', '1', 1, NULL, '2018-09-05', NULL, '1', 'yes', 'no'),
(2, 'Marketing Resources Name!', 'Marketing Resources Name! Marketing Resources Name! Marketing Resources Name!', '07eb38d687d20ca8dfb35f536b7717e7.jpg', '1', 1, NULL, '2018-09-05', NULL, '2', 'yes', 'no');

-- --------------------------------------------------------

--
-- Table structure for table `gymresourcesmarketingshowto`
--

CREATE TABLE `gymresourcesmarketingshowto` (
  `SysID` int(11) NOT NULL,
  `gymresourcesmarketingID` int(11) DEFAULT NULL,
  `ShowToBranch` int(11) NOT NULL,
  `ShowToBranchRole` int(11) NOT NULL,
  `AddedBy` int(11) NOT NULL,
  `UpdatedBy` int(11) NOT NULL,
...
--
-- Dumping data for table `gymresourcesmarketingshowto`
--

INSERT INTO `gymresourcesmarketingshowto` (`SysID`, `gymresourcesmarketingID`, `ShowToBranch`, `ShowToBranchRole`, `AddedBy`, `UpdatedBy`, `AddedDate`, `UpdatedDate`, `ResourcesMarketingStatus`, `DeleteStatus`) VALUES
(3, 1, 1, 1, 1, 0, '2018-09-05', '0000-00-00', 'yes', 'no'),
(4, 2, 1, 1, 1, 0, '2018-09-05', '0000-00-00', 'yes', 'no');
...
--
-- Table structure for table `masterdatabaseurl`
--

CREATE TABLE `masterdatabaseurl` (
  `SysID` int(11) NOT NULL,
  ...
  `AddedDate` date NOT NULL,
  `UpdatedDate` date NOT NULL,
  `BaseUrlStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `masterdatagymphases`
--

CREATE TABLE `masterdatagymphases` (
  `SysID` int(11) NOT NULL,
  `PhaseName` varchar(200) DEFAULT NULL,
  `Description` varchar(200) DEFAULT NULL,
  `DocumentLink` varchar(200) DEFAULT NULL,
  `HasSub` varchar(5) NOT NULL DEFAULT 'no',
  `AddedBy` int(11) NOT NULL,
  `UpdatedBy` int(11) DEFAULT NULL,
  `AddedDate` date NOT NULL,
  `UpdatedDate` date DEFAULT NULL,
  `DisplayOrderIndex` int(11) NOT NULL DEFAULT '1',
  `PhaseStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `masterdatagymphases`
--

INSERT INTO `masterdatagymphases` (`SysID`, `PhaseName`, `Description`, `DocumentLink`, `HasSub`, `AddedBy`, `UpdatedBy`, `AddedDate`, `UpdatedDate`, `DisplayOrderIndex`, `PhaseStatus`, `DeleteStatus`) VALUES
(1, 'Phase 1', 'First Phase', '0764a075d3eb18e949d36ef5c409d5b8.pdf', 'yes', 1, NULL, '2018-09-04', NULL, 1, 'yes', 'no'),
(2, 'Phase 2', 'Submenu List', '2b911f45a08a5f6f2100d8b5f305d6f7.png', 'no', 1, NULL, '2018-09-04', NULL, 1, 'yes', 'no');

-- --------------------------------------------------------

--
-- Table structure for table `masterdatagymphasesshowto`
--

CREATE TABLE `masterdatagymphasesshowto` (
  `SysID` int(11) NOT NULL,
  `masterdatagymphasesID` int(11) DEFAULT NULL,
  `ShowToBranch` int(11) NOT NULL,
  `ShowToBranchRole` int(11) NOT NULL,
  `AddedBy` int(11) NOT NULL,
  `UpdatedBy` int(11) NOT NULL,
...
--
-- Dumping data for table `masterdatagymphasesshowto`
--

INSERT INTO `masterdatagymphasesshowto` (`SysID`, `masterdatagymphasesID`, `ShowToBranch`, `ShowToBranchRole`, `AddedBy`, `UpdatedBy`, `AddedDate`, `UpdatedDate`, `PhaseStatus`, `DeleteStatus`) VALUES
(3, 1, 1, 1, 1, 0, '2018-09-04', '0000-00-00', 'yes', 'no'),
(4, 2, 1, 1, 1, 0, '2018-09-04', '0000-00-00', 'yes', 'no');
...
INSERT INTO `masterdatamenu` (`SysID`, `MenuName`, `Description`, `HasChild`, `Link`, `FaIcon`, `AddedBy`, `AddedDate`, `UpdatedBy`, `UpdatedDate`, `DisplayOrderIndex`, `MenuStatus`, `DeleteStatus`) VALUES
(1, 'Dashboard', 'dashboard', 'no', 'Welcome', 'fa fa-dashboard', 0, '0000-00-00', 0, '0000-00-00', 1, 'yes', 'no'),
(2, 'Master Data Management', 'Main Master Data', 'yes', '', 'fa fa-inbox', 0, '0000-00-00', 0, '0000-00-00', 999, 'yes', 'no'),
(3, 'Main Gym Management', 'Main Gym Management', 'yes', '', 'fa fa-empire', 0, '0000-00-00', 1, '2018-09-04', 3, 'yes', 'no'),
(4, 'Franchise Gym', 'Franchise Gym Management', 'yes', '', 'fa fa-address-card-o', 1, '2018-08-01', 1, '2018-08-14', 3, 'yes', 'no'),
(5, 'Gym Content Management', 'Gym Content Management', 'no', 'GymContent', 'fa fa-briefcase', 1, '2018-08-28', 0, '0000-00-00', 4, 'yes', 'no'),
(6, 'Gym Phase', 'Phase', 'no', 'ShowGymPhases', 'fa fa-sort-amount-asc', 1, '2018-09-04', 0, '0000-00-00', 2, 'yes', 'no'),
(7, 'Resources', 'show resources', 'no', 'ShowGymResources', 'fa fa-bookmark', 1, '2018-09-05', 1, '2018-09-05', 2, 'yes', 'no');
...
(1, 'Superadmin', 'Super', 'yes', 0, 1, '0000-00-00', '2018-09-05', 'yes', 'no'),
...
(457, 1, 'menu_1', 'menu', 1, 'Welcome', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(458, 1, 'menu_6', 'menu', 6, 'ShowGymPhases', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(459, 1, 'menu_3', 'menu', 3, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(460, 1, 'submenu_3', 'submenu', 3, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(461, 1, 'screen_5', 'screen', 5, 'MainUserInformation/mainUserlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(462, 1, 'submenu_4', 'submenu', 4, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(463, 1, 'screen_6', 'screen', 6, 'MainGymInformation/maingymlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(464, 1, 'menu_4', 'menu', 4, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(465, 1, 'submenu_6', 'submenu', 6, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(466, 1, 'screen_8', 'screen', 8, 'FranchiseGymInformation/franchisegymlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(467, 1, 'submenu_7', 'submenu', 7, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(468, 1, 'screen_9', 'screen', 9, 'FranchiseUserInformation/franchiseUserlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(469, 1, 'menu_5', 'menu', 5, 'GymContent', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(470, 1, 'menu_7', 'menu', 7, 'ShowGymResources', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(471, 1, 'menu_2', 'menu', 2, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(472, 1, 'submenu_8', 'submenu', 8, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(473, 1, 'screen_10', 'screen', 10, 'MasterDataAdminImageGallery/imagelist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(474, 1, 'screen_12', 'screen', 12, 'MasterDataTrainingImage/imagelist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(475, 1, 'submenu_9', 'submenu', 9, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(476, 1, 'screen_11', 'screen', 11, 'MasterDataBulletinBoard/bulletinboardlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(477, 1, 'submenu_10', 'submenu', 10, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(478, 1, 'screen_13', 'screen', 13, 'MasterDataTrainingVideo/videolist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(479, 1, 'submenu_5', 'submenu', 5, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(480, 1, 'screen_14', 'screen', 14, 'MasterDataGymPhase/gymphaselist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(481, 1, 'screen_15', 'screen', 15, 'MasterDataSubGymPhase/subgymphaselist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(482, 1, 'screen_17', 'screen', 17, 'GymResourcesCampaign/resourcescampaignlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(483, 1, 'screen_16', 'screen', 16, 'GymResourcesMarketing/resourcesmarketinglist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(484, 1, 'screen_18', 'screen', 18, 'GymResourcesAssetsArtwork/resourcesassetsartworklist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(485, 1, 'screen_19', 'screen', 19, 'GymResourcesDigitalSocialMedia/resourcesdigitalsocialmedialist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(486, 1, 'screen_7', 'screen', 7, 'MasterDataPosition/positionlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(487, 1, 'submenu_2', 'submenu', 2, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(488, 1, 'screen_4', 'screen', 4, 'MasterDataRole/rolelist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(489, 1, 'submenu_1', 'submenu', 1, '', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(490, 1, 'screen_1', 'screen', 1, 'MasterDataMenu/menulist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(491, 1, 'screen_2', 'screen', 2, 'MasterDataSubMenu/submenulist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', ''),
(492, 1, 'screen_3', 'screen', 3, 'MasterDataScreen/screenlist', 'yes', 0, '0000-00-00', 1, '2018-09-05', '', '');
...
INSERT INTO `masterdatascreen` (`SysID`, `SubMenuNameID`, `ScreenName`, `Description`, `Link`, `FaIcon`, `AddedBy`, `AddedDate`, `UpdatedBy`, `UpdatedDate`, `DisplayOrderIndex`, `ScreenStatus`, `DeleteStatus`) VALUES
(1, 1, 'Menu List', 'Menu List', 'MasterDataMenu/menulist', '', 0, '0000-00-00', 0, '0000-00-00', 1, 'yes', 'no'),
(2, 1, 'Submenu List', 'Submenu List', 'MasterDataSubMenu/submenulist', '', 0, '0000-00-00', 1, '2018-09-03', 2, 'yes', 'no'),
(3, 1, 'Screen List', 'Screen List', 'MasterDataScreen/screenlist', '', 0, '0000-00-00', 1, '2018-09-03', 3, 'yes', 'no'),
(4, 2, 'Role List', 'Role List', 'MasterDataRole/rolelist', '', 0, '0000-00-00', 0, '0000-00-00', 1, 'yes', 'no'),
(5, 3, 'Main Gym Users', 'Main Gym Users', 'MainUserInformation/mainUserlist', '', 0, '0000-00-00', 0, '0000-00-00', 1, 'yes', 'no'),
(6, 4, 'Gym Management', 'Main Gym', 'MainGymInformation/maingymlist', '', 0, '0000-00-00', 0, '0000-00-00', 1, 'yes', 'no'),
(7, 5, 'Position List', 'List of position', 'MasterDataPosition/positionlist', '', 0, '0000-00-00', 1, '2018-09-03', 999, 'yes', 'no'),
(8, 6, 'Gym', 'Gym', 'FranchiseGymInformation/franchisegymlist', '', 1, '2018-08-14', 0, '0000-00-00', 1, 'yes', 'no'),
(9, 7, 'Users', 'Users', 'FranchiseUserInformation/franchiseUserlist', '', 1, '2018-08-14', 0, '0000-00-00', 1, 'yes', 'no'),
(10, 8, 'Admin Image Gallery', 'Admin Image Gallery', 'MasterDataAdminImageGallery/imagelist', '', 1, '2018-08-15', 0, '0000-00-00', 1, 'yes', 'no'),
(11, 9, 'Bulletin Board', 'Bulletin Board', 'MasterDataBulletinBoard/bulletinboardlist', '', 1, '2018-08-16', 0, '0000-00-00', 1, 'yes', 'no'),
(12, 8, 'Training Image', 'Training Image', 'MasterDataTrainingImage/imagelist', '', 1, '2018-08-22', 0, '0000-00-00', 1, 'yes', 'no'),
(13, 10, 'Training Video', 'Training Video', 'MasterDataTrainingVideo/videolist', '', 1, '2018-08-22', 0, '0000-00-00', 1, 'yes', 'no'),
(14, 5, 'Gym Main Phase', 'Main Gym Phase', 'MasterDataGymPhase/gymphaselist', '', 1, '2018-09-03', 0, '0000-00-00', 1, 'yes', 'no'),
(15, 5, 'Sub Gym Main Phase', 'Sub Gym Phase', 'MasterDataSubGymPhase/subgymphaselist', '', 1, '2018-09-04', 0, '0000-00-00', 3, 'yes', 'no'),
(16, 5, 'Resource Marketing', 'Resource Marketing', 'GymResourcesMarketing/resourcesmarketinglist', '', 1, '2018-09-05', 0, '0000-00-00', 4, 'yes', 'no'),
(17, 5, 'Resource Campaign!', 'Resource Campaign', 'GymResourcesCampaign/resourcescampaignlist', '', 1, '2018-09-05', 1, '2018-09-05', 3, 'yes', 'no'),
(18, 5, 'Resource Assets and Artwork!', 'Resource Assets and Artwork', 'GymResourcesAssetsArtwork/resourcesassetsartworklist', '', 1, '2018-09-05', 1, '2018-09-05', 5, 'yes', 'no'),
(19, 5, 'Resource Digital & Social Media!', 'Resource Digital and Social Media', 'GymResourcesDigitalSocialMedia/resourcesdigitalsocialmedialist', '', 1, '2018-09-05', 1, '2018-09-05', 6, 'yes', 'no');

-- --------------------------------------------------------

--
-- Table structure for table `masterdatasubgymphases`
--

CREATE TABLE `masterdatasubgymphases` (
  `SysID` int(11) NOT NULL,
  `PhaseName` varchar(200) DEFAULT NULL,
  `Description` varchar(200) DEFAULT NULL,
  ...
  `AddedDate` date NOT NULL,
  `UpdatedDate` date DEFAULT NULL,
  `maingymphaseID` int(11) NOT NULL,
  `DisplayOrderIndex` int(11) NOT NULL DEFAULT '1',
  `SubPhaseStatus` varchar(10) NOT NULL,
  `DeleteStatus` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `masterdatasubgymphases`
--

INSERT INTO `masterdatasubgymphases` (`SysID`, `PhaseName`, `Description`, `Details`, `DocumentLink`, `AddedBy`, `UpdatedBy`, `AddedDate`, `UpdatedDate`, `maingymphaseID`, `DisplayOrderIndex`, `SubPhaseStatus`, `DeleteStatus`) VALUES
(1, 'Phase 1', 'Phase 1', 'Phase 1Phase 1Phase 1Phase 1', '9569481316407bfa1295955e2f69d2cd.pdf', 1, NULL, '2018-09-04', NULL, 1, 1, 'yes', 'no');

-- --------------------------------------------------------

--
-- Table structure for table `masterdatasubgymphasesshowto`
--

CREATE TABLE `masterdatasubgymphasesshowto` (
  `SysID` int(11) NOT NULL,
  `masterdatasubgymphasesID` int(11) DEFAULT NULL,
  `ShowToBranch` int(11) NOT NULL,
  `ShowToBranchRole` int(11) NOT NULL,
  `AddedBy` int(11) NOT NULL,
  `UpdatedBy` int(11) NOT NULL,
...
--
-- Dumping data for table `masterdatasubgymphasesshowto`
--

INSERT INTO `masterdatasubgymphasesshowto` (`SysID`, `masterdatasubgymphasesID`, `ShowToBranch`, `ShowToBranchRole`, `AddedBy`, `UpdatedBy`, `AddedDate`, `UpdatedDate`, `SubPhaseStatus`, `DeleteStatus`) VALUES
(1, 1, 1, 1, 1, 0, '2018-09-04', '0000-00-00', 'yes', 'no');
...
INSERT INTO `masterdatasubmenu` (`SysID`, `MenuNameID`, `SubMenuName`, `Description`, `HasChild`, `Link`, `FaIcon`, `AddedBy`, `AddedDate`, `UpdatedBy`, `UpdatedDate`, `DisplayOrderIndex`, `SubmenuStatus`, `DeleteStatus`) VALUES
(1, 2, 'Menu Management', 'Menu Management', 'yes', '', 'fa fa-book', 0, '0000-00-00', 1, '2018-09-03', 999, 'yes', 'no'),
(2, 2, 'Role Management', 'Role Management', 'yes', '', 'fa fa-blind', 0, '0000-00-00', 1, '2018-09-03', 998, 'yes', 'no'),
(3, 3, 'User Management', 'User Management', 'yes', '', 'fa fa-users', 0, '0000-00-00', 0, '0000-00-00', 1, 'yes', 'no'),
(4, 3, 'Gym Management', 'Gym Management', 'yes', '', 'fa fa-link', 0, '0000-00-00', 0, '0000-00-00', 1, 'yes', 'no'),
(5, 2, 'Data Management', 'Master Data', 'yes', '', 'fa fa-bookmark-o', 0, '0000-00-00', 1, '2018-09-03', 997, 'yes', 'no'),
(6, 4, 'Franchise Gym', 'Franchise Gym', 'yes', '', 'fa fa-link', 1, '2018-08-14', 0, '0000-00-00', 1, 'yes', 'no'),
(7, 4, 'Franchise Users', 'Franchise Users', 'yes', '', 'fa fa-users', 1, '2018-08-14', 0, '0000-00-00', 1, 'yes', 'no'),
(8, 2, 'Image Management', 'Image Management', 'yes', '', 'fa  fa-file-image-o', 1, '2018-08-15', 0, '0000-00-00', 1, 'yes', 'no'),
(9, 2, 'Bulletin Board', 'Bulletin Board', 'yes', '', 'fa fa-clipboard', 1, '2018-08-16', 1, '2018-08-16', 1, 'yes', 'no'),
(10, 2, 'Video Management', 'Video Management', 'yes', '', 'fa fa-video-camera', 1, '2018-08-22', 1, '2018-08-22', 1, 'yes', 'no');
...
--
-- Indexes for table `gymresourcesassetsartwork`
--
ALTER TABLE `gymresourcesassetsartwork`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `gymresourcesassetsartworkshowto`
--
ALTER TABLE `gymresourcesassetsartworkshowto`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `gymresourcescampaign`
--
ALTER TABLE `gymresourcescampaign`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `gymresourcescampaignshowto`
--
ALTER TABLE `gymresourcescampaignshowto`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `gymresourcesdigitalsocialmedia`
--
ALTER TABLE `gymresourcesdigitalsocialmedia`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `gymresourcesdigitalsocialmediashowto`
--
ALTER TABLE `gymresourcesdigitalsocialmediashowto`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `gymresourcesmarketing`
--
ALTER TABLE `gymresourcesmarketing`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `gymresourcesmarketingshowto`
--
ALTER TABLE `gymresourcesmarketingshowto`
  ADD PRIMARY KEY (`SysID`);
...
--
-- Indexes for table `masterdatabaseurl`
--
ALTER TABLE `masterdatabaseurl`
  ADD PRIMARY KEY (`SysID`);
...
--
-- Indexes for table `masterdatagymphases`
--
ALTER TABLE `masterdatagymphases`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `masterdatagymphasesshowto`
--
ALTER TABLE `masterdatagymphasesshowto`
  ADD PRIMARY KEY (`SysID`);
...
--
-- Indexes for table `masterdatasubgymphases`
--
ALTER TABLE `masterdatasubgymphases`
  ADD PRIMARY KEY (`SysID`);

--
-- Indexes for table `masterdatasubgymphasesshowto`
--
ALTER TABLE `masterdatasubgymphasesshowto`
  ADD PRIMARY KEY (`SysID`);
...
--
-- AUTO_INCREMENT for table `gymresourcesassetsartwork`
--
ALTER TABLE `gymresourcesassetsartwork`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gymresourcesassetsartworkshowto`
--
ALTER TABLE `gymresourcesassetsartworkshowto`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gymresourcescampaign`
--
ALTER TABLE `gymresourcescampaign`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gymresourcescampaignshowto`
--
ALTER TABLE `gymresourcescampaignshowto`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gymresourcesdigitalsocialmedia`
--
ALTER TABLE `gymresourcesdigitalsocialmedia`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gymresourcesdigitalsocialmediashowto`
--
ALTER TABLE `gymresourcesdigitalsocialmediashowto`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gymresourcesmarketing`
--
ALTER TABLE `gymresourcesmarketing`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `gymresourcesmarketingshowto`
--
ALTER TABLE `gymresourcesmarketingshowto`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `masterdatabaseurl`
--
ALTER TABLE `masterdatabaseurl`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `masterdatagymphases`
--
ALTER TABLE `masterdatagymphases`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `masterdatagymphasesshowto`
--
ALTER TABLE `masterdatagymphasesshowto`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `masterdatarolemapping`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=493;
...
--
-- AUTO_INCREMENT for table `masterdatasubgymphases`
--
ALTER TABLE `masterdatasubgymphases`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `masterdatasubgymphasesshowto`
--
ALTER TABLE `masterdatasubgymphasesshowto`
  MODIFY `SysID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
